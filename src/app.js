...
import challengesRouter from "./routes/challenges.router.js";  // checkChallenges 라우터 추가
...
app.use("/api", [PlaysRouter, gatchaRouter, playersRouter, teamRouter, usersRouter, reinforce, challengesRouter]);  // 라우터 추가
